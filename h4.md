...
- Tämän jälkeen yritän sellaista ratkaisua että vaihdan jnz -> jz käyttämällä patch instructionia
...
- Noh ei toiminut, en tiedä miksi ei toiminut koska jos vaihdan jnz -> jz joka tekee funktiosta käänteisen Ghidrassa niin sen pitäisi toimia toistenpäin, samalla logiikalla kun !=0. Tämä olisi myös hyvä käydä läpi tunnilla miten saan oikean ratkaisun ja miksi oma ratkaisu ei toiminut.

## d) ja eteenpäin

- Tässä vaiheessa jokaisen edelliseen tehtävään mennyt ihan jumalattomasti aikaa joten yritän vielä huomenna sunnuntaina 8.2.2026 tehdä lisää seuraavat tehtävät jos saisin Ghidrasta jotain kiinni.
